class loadouts
{
	...
	class B_Medic_F
	{
		...
		uniformItems[] = {{"ItemcTabHCam", 1}}; // Items to place in uniform. Includes weapon magazines
		vestItems[] = {{"30Rnd_65x39_caseless_mag", 5}, {"30Rnd_65x39_caseless_mag_Tracer", 2}, {"ACE_EntrenchingTool", 1}, {"30Rnd_9x21_Mag", 2}}; // Items to place in vest. Includes weapon magazines
		...
		basicMedVest[] = {}; // Items to be placed in the vest only when basic medical is being used
		basicMedBackpack[] = {{"ACE_bloodIV", 6}, {"ACE_bloodIV_500", 10}, {"ACE_morphine", 25}, {"ACE_epinephrine", 25}, {"ACE_fieldDressing", 50}}; // Items to be placed in the backpack only when basic medical is being used
